...
START_TEST(s21_cosTEST) {
  ...
  ck_assert_ldouble_eq_tol(s21_cos(11 * s21_PI / 17), cos(11 * s21_PI / 17),
                           1e-6);
  ck_assert_ldouble_eq_tol(s21_cos(32 * s21_PI / 3), cos(32 * s21_PI / 3),
                           1e-6);
  ck_assert_ldouble_eq_tol(s21_cos(-0), cos(-0), 1e-6);
  ck_assert_ldouble_eq_tol(s21_cos(-s21_PI / 6), cos(-s21_PI / 6), 1e-6);
  ck_assert_ldouble_eq_tol(s21_cos(-s21_PI / 4), cos(-s21_PI / 4), 1e-6);
  ck_assert_ldouble_eq_tol(s21_cos(-s21_PI / 2), cos(-s21_PI / 2), 1e-6);
  ck_assert_ldouble_eq_tol(s21_cos(-2 * s21_PI / 3), cos(-2 * s21_PI / 3),
                           1e-6);
  ck_assert_ldouble_eq_tol(s21_cos(-3 * s21_PI / 4), cos(-3 * s21_PI / 4),
                           1e-6);
  ...
  ck_assert_ldouble_eq_tol(s21_cos(-7 * s21_PI / 6), cos(-7 * s21_PI / 6),
                           1e-6);
  ck_assert_ldouble_eq_tol(s21_cos(-5 * s21_PI / 4), cos(-5 * s21_PI / 4),
                           1e-6);
  ck_assert_ldouble_eq_tol(s21_cos(-4 * s21_PI / 3), cos(-4 * s21_PI / 3),
                           1e-6);
  ck_assert_ldouble_eq_tol(s21_cos(-3 * s21_PI / 2), cos(-3 * s21_PI / 2),
                           1e-6);
  ck_assert_ldouble_eq_tol(s21_cos(-5 * s21_PI / 3), cos(-5 * s21_PI / 3),
                           1e-6);
  ck_assert_ldouble_eq_tol(s21_cos(-7 * s21_PI / 4), cos(-7 * s21_PI / 4),
                           1e-6);
  ck_assert_ldouble_eq_tol(s21_cos(-11 * s21_PI / 6), cos(-11 * s21_PI / 6),
                           1e-6);
  ck_assert_ldouble_eq_tol(s21_cos(-2 * s21_PI), cos(-2 * s21_PI), 1e-6);
...
START_TEST(s21_sinTEST) {
  ...
  ck_assert_ldouble_eq_tol(s21_sin(11 * s21_PI / 17), sin(11 * s21_PI / 17),
                           1e-6);
  ck_assert_ldouble_eq_tol(s21_sin(32 * s21_PI / 3), sin(32 * s21_PI / 3),
                           1e-6);
  ck_assert_ldouble_eq_tol(s21_sin(-0), sin(-0), 1e-6);
  ck_assert_ldouble_eq_tol(s21_sin(-s21_PI / 6), sin(-s21_PI / 6), 1e-6);
  ck_assert_ldouble_eq_tol(s21_sin(-s21_PI / 4), sin(-s21_PI / 4), 1e-6);
  ck_assert_ldouble_eq_tol(s21_sin(-s21_PI / 2), sin(-s21_PI / 2), 1e-6);
  ck_assert_ldouble_eq_tol(s21_sin(-2 * s21_PI / 3), sin(-2 * s21_PI / 3),
                           1e-6);
  ...
  ck_assert_ldouble_eq_tol(s21_sin(-7 * s21_PI / 6), sin(-7 * s21_PI / 6),
                           1e-6);
  ck_assert_ldouble_eq_tol(s21_sin(-5 * s21_PI / 4), sin(-5 * s21_PI / 4),
                           1e-6);
  ck_assert_ldouble_eq_tol(s21_sin(-4 * s21_PI / 3), sin(-4 * s21_PI / 3),
                           1e-6);
  ck_assert_ldouble_eq_tol(s21_sin(-3 * s21_PI / 2), sin(-3 * s21_PI / 2),
                           1e-6);
  ck_assert_ldouble_eq_tol(s21_sin(-5 * s21_PI / 3), sin(-5 * s21_PI / 3),
                           1e-6);
  ck_assert_ldouble_eq_tol(s21_sin(-7 * s21_PI / 4), sin(-7 * s21_PI / 4),
                           1e-6);
  ck_assert_ldouble_eq_tol(s21_sin(-11 * s21_PI / 6), sin(-11 * s21_PI / 6),
                           1e-6);
  ck_assert_ldouble_eq_tol(s21_sin(-2 * s21_PI), sin(-2 * s21_PI), 1e-6);
...
START_TEST(s21_tanTEST) {
  ...
  ck_assert_ldouble_eq_tol(s21_tan(11 * s21_PI / 17), tan(11 * s21_PI / 17),
                           1e-6);
  ck_assert_ldouble_eq_tol(s21_tan(32 * s21_PI / 3), tan(32 * s21_PI / 3),
                           1e-6);
  ck_assert_ldouble_eq_tol(s21_tan(-0), tan(-0), 1e-6);
  ck_assert_ldouble_eq_tol(s21_tan(-s21_PI / 6), tan(-s21_PI / 6), 1e-6);
  ck_assert_ldouble_eq_tol(s21_tan(-s21_PI / 4), tan(-s21_PI / 4), 1e-6);
  ck_assert_ldouble_eq_tol(s21_tan(-2 * s21_PI / 3), tan(-2 * s21_PI / 3),
                           1e-6);
  ck_assert_ldouble_eq_tol(s21_tan(-3 * s21_PI / 4), tan(-3 * s21_PI / 4),
                           1e-6);
  ck_assert_ldouble_eq_tol(s21_tan(-5 * s21_PI / 6), tan(-5 * s21_PI / 6),
                           1e-6);
  ck_assert_ldouble_eq_tol(s21_tan(-s21_PI), tan(-s21_PI), 1e-6);
  ck_assert_ldouble_eq_tol(s21_tan(-7 * s21_PI / 6), tan(-7 * s21_PI / 6),
                           1e-6);
  ck_assert_ldouble_eq_tol(s21_tan(-5 * s21_PI / 4), tan(-5 * s21_PI / 4),
                           1e-6);
  ck_assert_ldouble_eq_tol(s21_tan(-4 * s21_PI / 3), tan(-4 * s21_PI / 3),
                           1e-6);
  ck_assert_ldouble_eq_tol(s21_tan(-5 * s21_PI / 3), tan(-5 * s21_PI / 3),
                           1e-6);
  ck_assert_ldouble_eq_tol(s21_tan(-7 * s21_PI / 4), tan(-7 * s21_PI / 4),
                           1e-6);
  ck_assert_ldouble_eq_tol(s21_tan(-11 * s21_PI / 6), tan(-11 * s21_PI / 6),
                           1e-6);
  ck_assert_ldouble_eq_tol(s21_tan(-2 * s21_PI), tan(-2 * s21_PI), 1e-6);
